...
public class ClaimDetailsServiceImpl implements ClaimDetailsService {
	...
	public ClaimDetails updateClaim(String claimId, ClaimDetails claimDetails) {
		...
		Policy policy = this.policyService.findPolicyByPolicyNo(claimDetails.getPolicy().getPolicyNo());
		Surveyor surveyor = this.surveyorService.findSurveyorBySurveyorId(claimDetails.getSurveyor().getSurveyorId());
