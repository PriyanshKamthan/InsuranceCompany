...
public class MyController {
	...
	@GetMapping("/home")
	public Message home() {
		return new Message("Welcome to Insurance Company Home Page");
	}
	...
	public Message getSurveyorFeesByClaimId(@PathVariable String claimId) {
		int fees = this.claimDetailsService.getSurveyorFees(claimId);
		Message msg = new Message(fees+"");
		return msg;
	}
